document.addEventListener("DOMContentLoaded", () => {
  ...
  // Existing code: Toggle mobile nav
  hamburger.addEventListener("click", toggleMobileNav);

  // Existing code: Close mobile nav when clicking outside
  mainContent.addEventListener("click", closeMobileNav);

  // Existing code: Close mobile nav when clicking nav buttons
  ...
  // New code: Smooth scroll functionality
